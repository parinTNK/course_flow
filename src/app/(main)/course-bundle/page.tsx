  ...
  return (
    <div className="min-h-screen flex flex-col bg-transparent overflow-x-hidden">
      ...
      <main className="flex-1 pt-24 pb-10">
        ...
        {/* เปลี่ยนจาก flex-wrap grid เป็น vertical list */}
...
// Component สำหรับ Bundle List Item
const BundleListItem: React.FC<{ bundle: Bundle }> = ({ bundle }) => {
    ...
    >
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1">
          ...
          {/* Tags/Course list placeholder */}
          <div className="text-sm text-blue-500 mb-4">
            Service Design Essentials, UX/UI Design Beginner, Product Design for
            Business
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4 text-sm text-gray-500">
              <span>{bundle.courses_count || 0} Courses</span>
              <span>{bundle.total_learning_time || 0} Hours</span>
            </div>
          </div>
        </div>
      </div>
